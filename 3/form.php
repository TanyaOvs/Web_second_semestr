...
<div class="form">
    ...
    <form action="index.php" method="POST">
        <ol>
            <li>
                <label>
                    ФИО:<br /><input name="FIO" type="text" placeholder="Иванов Иван Иванович" />
                </label><br />
            </li>
...
if(isset($_GET['actionsCompleted']) && $_GET['actionsCompleted'] == '1') {
    ...
    echo "<div error-message style='margin-top: 10px;font: small-caps 1.2rem sans-serif;font-size: 36px;text-align: center;color: #68006C;background: #FDE8FD;'>Форма успешно отправлена!</div>";
}
?>
</body>
</html>
